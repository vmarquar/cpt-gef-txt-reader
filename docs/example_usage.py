from gef_reader import read_gef_file, read_alt_gef_file
...
FOLDER_PATH = "./data/GEF_SAMPLES/ASCII"
...
if __name__ == '__main__':
    ...
    if(RUN_EXAMPLE3):
        ...
        all_measurements = []
        all_cpt_header_info = []
        for file_path in glob(folder_path + '/*.GEF.txt'):
            cpt_header, measurement_columns_and_units, measurements = read_gef_file(file_path)
    ...
    if(RUN_EXAMPLE4):
        ...
        # Display the points on a map etc.
        (...)
