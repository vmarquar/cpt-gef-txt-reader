...
def pytess_triangulate(points):  
    ...
    # Compute Delauney
    triangle_ids = computeDelaunayTriangulation(classpoints)
...
def pytess_voronoi(points, buffer_percent=100):
    """
    ...
    # Compute Voronoi
    vertices,edges,poly_dict = computeVoronoiDiagram(classpoints)
